...
{	
	...
	{	
		...
		[Information("Here you can specify the length of the fade in and fade out at the start and end of your level.",InformationAttribute.InformationType.Info,false)]
